...
| Action     | Provided By     | Subject                                             | Other Notes                                                       |
| ---------- | --------------- | --------------------------------------------------- | ----------------------------------------------------------------- |
| `navigate` | Backstage Core  | The URL of the page that was navigated to           |                                                                   |
| `click`    | Backstage Core  | The text of the link that was clicked on            | The `to` attribute represents the URL clicked to                  |
| `search`   | Search Plugin   | The search term entered in any search bar component | The `searchTypes` attribute holds `types` constraining the search |
| `discover` | (By Convention) | The title of the search result that was clicked on  | The `value` is the result rank. A `to` attribute is also provided |
